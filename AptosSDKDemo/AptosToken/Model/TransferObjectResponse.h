#ifndef TRANSFEROBJECTRESPONSE_H
#define TRANSFEROBJECTRESPONSE_H
...
public:
    ...
    static TransferObjectResponse from_json(const nlohmann::json& j);
};
}
#endif // TRANSFEROBJECTRESPONSE_H
