#ifndef ADDTOKENPROPERTYRESPONSE_H
#define ADDTOKENPROPERTYRESPONSE_H
...
class AddTokenPropertyResponse
{
public:
    AddTokenPropertyResponse() = default;
...
#endif // ADDTOKENPROPERTYRESPONSE_H
