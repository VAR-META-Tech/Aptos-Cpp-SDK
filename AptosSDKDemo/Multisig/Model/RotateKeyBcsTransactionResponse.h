#ifndef ROTATEKEYBCSTRANSACTIONRESPONSE_H
#define ROTATEKEYBCSTRANSACTIONRESPONSE_H
...
namespace AptosSDKDemo
{
    ...
    ///     }
    /// }
class RotateKeyBcsTransactionResponse
{
private:
    std::string hash;
    std::string sender;
...
public:
    ...
    static RotateKeyBcsTransactionResponse from_json(const nlohmann::json& j);
};
}
#endif // ROTATEKEYBCSTRANSACTIONRESPONSE_H
